            ...
            return (
                <>
                    <div className="user">
                        ...
                        <div className="defaultText" style={{fontSize: 20}}>Никнейм: {user.nickname}</div>
                        <div className="defaultText" style={{fontSize: 20}}>Создан: {new Date(user.createdAt).toLocaleString()}</div>
                    </div>
